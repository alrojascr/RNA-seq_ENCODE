...
input_dir="/opt/data/HPC01A/alexis_rojasc/OSA_RNA-seq/Mapping/STAR-RSEM/output/transcriptome_bam"
output_base_dir="/opt/data/HPC01A/alexis_rojasc/OSA_RNA-seq/Mapping_quality/transcriptome/Samtools"
