...
#SBATCH --nodelist=pujnodo0                            # Request specific node
...
# Directories
FASTQ_DIR="/opt/data/HPC01A/alexis_rojasc/OSA_RNA-seq/Control_quality/FastQC_Clean"
OUTPUT_DIR="/opt/data/HPC01A/alexis_rojasc/OSA_RNA-seq/Control_quality/FastQC_Clean/FastQC_Output"
